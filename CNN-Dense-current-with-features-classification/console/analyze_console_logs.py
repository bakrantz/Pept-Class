...
def main():
    ...
    docx_files = [
        "console-CNN-Dense-5ms-rpt1.docx",
        "console-CNN-Dense-5ms-rpt2.docx",
        "console-CNN-Dense-5ms-rpt3.docx",
        "console-CNN-Dense-5ms-rpt4.docx",
        "console-CNN-Dense-5ms-rpt5.docx",
    ]

    # List of global and event-level features docx files
    docx_files_20ms = [
        "console-CNN-Dense-20ms-rpt1.docx",
        "console-CNN-Dense-20ms-rpt2.docx",
        "console-CNN-Dense-20ms-rpt3.docx",
        "console-CNN-Dense-20ms-rpt4.docx",
        "console-CNN-Dense-20ms-rpt5.docx",
    ]
