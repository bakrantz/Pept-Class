...
def main():
    ...
    docx_files = [
        "console-CNN_Dense_state_sequences_with_features-5ms-rpt1.docx",
        "console-CNN_Dense_state_sequences_with_features-5ms-rpt2.docx",
        "console-CNN_Dense_state_sequences_with_features-5ms-rpt3.docx",
        "console-CNN_Dense_state_sequences_with_features-5ms-rpt4.docx",
        "console-CNN_Dense_state_sequences_with_features-5ms-rpt5.docx",
    ]

    # List of 20ms min event duration docx files
    docx_files_20ms = [
        "console-CNN_Dense_state_sequences_with_features-20ms-rpt1.docx",
        "console-CNN_Dense_state_sequences_with_features-20ms-rpt2.docx",
        "console-CNN_Dense_state_sequences_with_features-20ms-rpt3.docx",
        "console-CNN_Dense_state_sequences_with_features-20ms-rpt4.docx",
        "console-CNN_Dense_state_sequences_with_features-20ms-rpt5.docx",
    ]
