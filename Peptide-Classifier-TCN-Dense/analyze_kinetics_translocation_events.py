...
def analyze_translocation_kinetics(filepath, peptide_name, time_step=0.001):
    ...
    try:
        ...
        if dwell_times_state_0:
            ...
            # Step 3: Fit CDF of State 0 to exponential
            popt_0, pcov_0 = curve_fit(fit_exponential_cdf, t_state_0, cdf_state_0, p0=[1]) # Initial guess for k=1
            k_state_0 = popt_0[0]
        ...
        if dwell_times_state_1:
            ...
            popt_1, pcov_1 = curve_fit(fit_exponential_cdf, t_state_1, cdf_state_1, p0=[1]) # Initial guess for k=1
            k_state_1 = popt_1[0]
            plt.figure(figsize=(8, 6))
        ...
        if overall_event_lengths:
            ...
            popt_overall, pcov_overall = curve_fit(fit_exponential_cdf, t_overall, cdf_overall, p0=[1]) # Initial guess for k=1
        ...
        # Step 3 (Continued): Print the k values
