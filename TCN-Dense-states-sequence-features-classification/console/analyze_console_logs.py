...
def main():
    ...
    docx_files = [
        "TCN-Dense-state-seqs-event-level-features-5ms-rpt1.docx",
        "TCN-Dense-state-seqs-event-level-features-5ms-rpt2.docx",
        "TCN-Dense-state-seqs-event-level-features-5ms-rpt3.docx",
        "TCN-Dense-state-seqs-event-level-features-5ms-rpt4.docx",
        "TCN-Dense-state-seqs-event-level-features-5ms-rpt5.docx",
    ]

    # List of 20ms min event duration docx files
    docx_files_20ms = [
        "TCN-Dense-state-seqs-event-level-features-20ms-rpt1.docx",
        "TCN-Dense-state-seqs-event-level-features-20ms-rpt2.docx",
        "TCN-Dense-state-seqs-event-level-features-20ms-rpt3.docx",
        "TCN-Dense-state-seqs-event-level-features-20ms-rpt4.docx",
        "TCN-Dense-state-seqs-event-level-features-20ms-rpt5.docx",
    ]
