...
if __name__ == "__main__":
    ...
    try:
        ...
        # Based on your image and prior runs, we can guide it to the four
        # distinct peaks, including the small one at the highest current.
        # You can adjust these values as needed for a perfect fit.
        initial_centroids_guess = np.array([-0.07, 2.5, 4.8, 5.4])
