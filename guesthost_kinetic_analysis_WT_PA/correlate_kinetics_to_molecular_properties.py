...
def load_and_combine_kinetics(kinetics_dir='./results/'):
    ...
    """
    search_path = os.path.join(kinetics_dir, '*_consolidated_kinetics.csv')
    ...
    for f in files:
        ...
        peptide_full_name = os.path.basename(f).split('_consolidated_kinetics.csv')[0]
...
def main():
    ...
    try:
        ...
        output_path = './results/correlation_summary.csv'
        ...
        best_output_path = './results/best_correlation_per_transition.csv'
