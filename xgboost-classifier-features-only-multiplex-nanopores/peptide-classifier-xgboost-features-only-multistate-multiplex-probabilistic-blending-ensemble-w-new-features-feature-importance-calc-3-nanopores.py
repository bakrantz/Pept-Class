...
if __name__ == "__main__":
    ...
    # --- CHANGE THIS LINE TO SELECT YOUR DESIRED NANPORES ---
    nanopore_names_for_ensemble = ['PA_F427Y']
    # You can change this list to any combination you want from the full set:
    # ['PA', 'PA_F427A', 'PA_F427Y']
    # ['PA', 'PA_F427Y']
    # ['PA_F427A', 'PA_F427Y']

    # --- The following lines automatically create the encoding based on your selection ---
