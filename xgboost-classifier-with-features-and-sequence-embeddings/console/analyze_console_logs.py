...
def main():
    # List of your DOCX files 5ms min event duration
    docx_files = [
        "console-xgboost_features_sequence_embeddings_cnn_5ms-rpt1.docx",
        "console-xgboost_features_sequence_embeddings_cnn_5ms-rpt2.docx",
        "console-xgboost_features_sequence_embeddings_cnn_5ms-rpt3.docx",
        "console-xgboost_features_sequence_embeddings_cnn_5ms-rpt4.docx",
        "console-xgboost_features_sequence_embeddings_cnn_5ms-rpt5.docx",
    ]

    # List of 20ms min event duration docx files
    docx_files_20ms = [
        "console-xgboost_features_sequence_embeddings_cnn_20ms-rpt1.docx",
        "console-xgboost_features_sequence_embeddings_cnn_20ms-rpt2.docx",
        "console-xgboost_features_sequence_embeddings_cnn_20ms-rpt3.docx",
        "console-xgboost_features_sequence_embeddings_cnn_20ms-rpt4.docx",
        "console-xgboost_features_sequence_embeddings_cnn_20ms-rpt5.docx",
    ]
